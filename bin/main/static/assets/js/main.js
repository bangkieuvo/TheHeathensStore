...
/*==================================================================
    ...
    if (e.key === "Escape") {
        ...
        // Đóng favorite nếu đang mở
        if ($('.js-panel-favorite').hasClass('show-header-favorite')) {
            $('.js-panel-favorite').removeClass('show-header-favorite');
        }

        // (optional) đóng search modal
        if ($('.modal-search-header').hasClass('show-modal-search')) {
            $('.modal-search-header').removeClass('show-modal-search');
            $('.js-show-modal-search').css('opacity','1');
        }

        // (optional) đóng modal1
